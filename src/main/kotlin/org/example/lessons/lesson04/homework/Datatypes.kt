...
//val v6: Boolean = FALSE – false должно быть маленькими в Boolean
val v7: Char = 'c'
val v8: Int = 500
...
val v13: String = "true" //так как в кавычках
...
//val v30: Boolean = FALSE – false должно быть маленькими в Boolean
val v31: Double = 0.007
//val v32: String = “🤯” – неправильные кавычки
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
//val v34: String = ‘65535’ – неправильные кавычки
...
//val v44 = TRUE – true должно быть маленькими в Boolean
...
val prices: List<Int> = listOf(500, 345, 244)
//4. Хранить длину очереди в столовой до миллиардной доли сантиметра.
val queue: Double = 233424.234
...
val usefulthemes: Set<String> = setOf("Наши процессы", "Как у всех дела")